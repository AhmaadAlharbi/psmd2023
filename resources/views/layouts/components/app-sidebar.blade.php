	...
	<aside class="app-sidebar sidebar-scroll">
		...
		<div class="main-sidemenu">
			...
			<ul class="side-menu">
				...
				<li class="slide">
					<a class="side-menu__item" href="{{route('dashboard.index')}}"><svg
				...
				<li class="side-item side-item-category">الأعطال</li>
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="{{route('dashboard.add_task')}}">اصدار أمر العمل</a></li>
						<li><a class="slide-item" href="{{route('dashboard.showTasks',['status'=>'pending'])}}">الأعطال
								الغير
								منجزة</a></li>
						<li><a class="slide-item"
								href="{{route('dashboard.showTasks',['status'=>'completed'])}}">الأعطال المنجزة</a></li>
						...
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								...
								<li><a class="sub-side-menu__item"
										href="{{url('file-manager-list')}}">File-Manager-List</a></li>
								<li><a class="sub-side-menu__item"
										href="{{url('file-manager-details')}}">File-Manager-Details</a></li>
								<li><a class="sub-side-menu__item"
										href="{{url('file-attachments')}}">File-Attachments</a></li>
							</ul>
						</li>
					</ul>
				</li>
							...
							<ul class="sub-slide-menu">
								...
								<li class="sub-slide2">
									<a class="sub-side-menu__item" data-bs-toggle="sub-slide2"
										href="javascript:void(0);"><span class="sub-side-menu__label">Level-2.3</span><i
					...
					<ul class="slide-menu">
						...
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								...
								<li><a class="sub-side-menu__item" href="{{url('mail-settings')}}">mail-settings</a>
								</li>
						...
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								...
								<li><a class="sub-side-menu__item" href="{{url('product-details')}}">Product-Details</a>
								</li>
