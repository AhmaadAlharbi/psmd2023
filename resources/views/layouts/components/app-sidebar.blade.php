				...
				<div class="sticky">
					<aside class="app-sidebar sidebar-scroll">
						<div class="main-sidebar-header active">
							...
							<a class="desktop-logo logo-dark active" href="{{url('index')}}"><img src="{{asset('assets/img/brand/logo-white.png')}}" class="main-logo" alt="logo"></a>
							<a class="logo-icon mobile-logo icon-light active" href="{{url('index')}}"><img src="{{asset('assets/img/brand/favicon.png')}}" alt="logo"></a>
							<a class="logo-icon mobile-logo icon-dark active" href="{{url('index')}}"><img src="{{asset('assets/img/brand/favicon-white.png')}}" alt="logo"></a>
						</div>
							...
							<ul class="side-menu">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="{{url('icons-1')}}">Font Awesome </a></li>
										<li><a class="slide-item" href="{{url('icons-2')}}">Material Design Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-3')}}">Simple Line Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-4')}}">Feather Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-5')}}">Ionic Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-6')}}">Flag Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-7')}}">Pe7 Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-8')}}">Themify Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-9')}}">Typicons Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-10')}}">Weather Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-11')}}">Material Icons</a></li>
										<li><a class="slide-item" href="{{url('icons-12')}}">Bootstrap Icons</a></li>
									</ul>
								</li>
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li class="sub-slide">
											...
											<ul class="sub-slide-menu">
												<li><a class="sub-side-menu__item" href="{{url('file-manager')}}">File-Manager</a></li>
												<li><a class="sub-side-menu__item" href="{{url('file-manager-list')}}">File-Manager-List</a></li>
												<li><a class="sub-side-menu__item" href="{{url('file-manager-details')}}">File-Manager-Details</a></li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="{{url('switcher-1')}}">Switcher-1</a></li>
										<li class="sub-slide">
